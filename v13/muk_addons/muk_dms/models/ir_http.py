...
#             self, xmlid=xmlid, model=model, id=id, field=field, unique=unique, filename=filename, mimetype=mimetype,
#             filename_field=filename_field, download=download, default_mimetype=default_mimetype, access_token=access_token)
        
        res_status, res_headers, res_content = super().binary_content(
