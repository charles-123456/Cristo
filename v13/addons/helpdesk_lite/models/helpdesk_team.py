...
class SupportTeam(models.Model):
    ...
    reply_to = fields.Char(string='Reply-To', help="The email address put in the 'Reply-To' of all emails sent by Odoo about cases in this support team")
    ...
    def _get_default_team_id(self, user_id=None):
        ...
        if not team_id or not team_id.exists():
            team_id = self.env['helpdesk_lite.team'].sudo().search(['|',('user_id', '=', user_id),('member_ids', '=', user_id)], limit=1)
        if not team_id:
