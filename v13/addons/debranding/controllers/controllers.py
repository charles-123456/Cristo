...
if hasattr(sys, 'frozen'):
    ...
    loader = jinja2.PackageLoader('odoo.addons.debranding', "views")
...
class OdooDebrand(Database):
    ...
    def _render_template(self, **d):
        ...
        d['company_name'] = company_id and company_id[0].name or ''
        
#         Below was commented because it is used for website module BEGIN
